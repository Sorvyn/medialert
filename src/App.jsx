          ...
          {tab === "home" && (
            <div style={{ padding: "16px 20px", animation: "slideUp 0.4s ease" }}>
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
                <input value={customQuery} onChange={e => setCustomQuery(e.target.value)} onKeyDown={e => e.key === "Enter" && handleCustom()} placeholder="e.g. 'my dad cut his hand badly...'" style={{ flex: 1, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "12px 14px", color: "#fff", fontSize: 13, outline: "none", fontFamily: "'DM Sans', sans-serif" }} />
          ...
          {tab === "hospitals" && (
            <div style={{ padding: "16px 20px", animation: "slideUp 0.4s ease" }}>
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
                <input value={hospitalLocation} onChange={e => setHospitalLocation(e.target.value)} onKeyDown={e => e.key === "Enter" && findHospitals()} placeholder="e.g. Lahore, Karachi, Islamabad..." style={{ flex: 1, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "12px 14px", color: "#fff", fontSize: 13, outline: "none", fontFamily: "'DM Sans', sans-serif" }} />
